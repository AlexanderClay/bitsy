...
It will then output "arabic2.bitsyfont"
...
- The script "ttx_to_bitsyfont.js" cannot read positions below the underline in your font.
It works only when all glyphs are above the underline, but that's not a good way to design a font.
You could create an alternative version of your font for Bitsy where every character is above the underline.

Moving every glyph above the underline could be done like this in FontStruct:
